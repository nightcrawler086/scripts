...
BEGIN {
	...
	function Text-Output {
		...
		$OUTFILE = "${TIMESTAMP}_${$OBJ.SourceSystem}-provisioning-script.txt"
		$SUBSET = $OUTPUT | Select-Object -ExpandProperty SourceSystem -Unique
		ForEach ($OBJ in $SUBSET) {
			Write-Output "# Provisioning Script for $($OBJ.SourceSystem)`r`n" | Tee-Object $OUTFILE -Append
		}
		Write-Output "`r`n## Target Production VDM Creation Commands`r`n"
		Write-Output "``````"
		$SUBSET = $OUTPUT | Where-Object {$_.CommandType -eq "prdVdmCreate"}
		ForEach ($OBJ in $SUBSET) {
			Write-Output "$($OBJ.CommandString)" | Tee-Object $OUTFILE -Append
		}
		Write-Output "``````"
		Write-Output "`r`n## Target Production Interface Creation Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production VDM Attach Interface Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production VDM Replication Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production Interconnect Passphrase Creation Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production Interconnect Creation Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production CIFS Server Creation Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production CIFS Server Join Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production NFS LDAP Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production Filesystem Create Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production Filesystem Qtree Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production Filesystem Mount Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production CIFS Export Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production NFS Export Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production Filesystem Dedupe Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Production Filesystem Checkpoint Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Cob (DR) Interface Create Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Cob (DR) VDM Interface Attach Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Cob (DR) Interconnect Passphrase Create Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Cob (DR) Interconnect Create Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Cob (DR) Filesystem Create Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Cob (DR) Filesystem Mount Commands`r`n"
		Write-Output "``````"
		...
		Write-Output "``````"
		Write-Output "`r`n## Target Cob (DR) Filesystem Checkpoint Commands`r`n"
		Write-Output "``````"
