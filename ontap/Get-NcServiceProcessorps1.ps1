...
PROCESS {
	ForEach ($Cluster in $Clusters) {
		...
		# our custom object
		$SPS = Get-NcNode | Get-NcServiceProcessor | Select-Object NcController,Node,@{Name="IpAddress";Expression={$_.IpAddress -join ','}},MacAddress,FirmwareVersion,Status
